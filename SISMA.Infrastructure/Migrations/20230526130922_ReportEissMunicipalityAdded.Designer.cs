...
namespace SISMA.Infrastructure.Migrations
{
    ...
    [Migration("20230526130922_ReportEissMunicipalityAdded")]
    partial class ReportEissMunicipalityAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SISMA.Infrastructure.Data.Models.Common.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SISMA.Infrastructure.Data.Models.Common.CommonCourtDistance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_common_court_distance");

                    b.HasIndex("CourtId")
                        .HasDatabaseName("ix_common_court_distance_court_id");

                    b.HasIndex("EkEkatteId")
                        .HasDatabaseName("ix_common_court_distance_ek_ekatte_id");

                    b.ToTable("common_court_distance", (string)null);
                });
            ...
            modelBuilder.Entity("SISMA.Infrastructure.Data.Models.Report.ReportEisppMunicipality", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_report_eispp_municipality");

                    b.HasIndex("CatalogCodeId")
                        .HasDatabaseName("ix_report_eispp_municipality_catalog_code_id");

                    b.HasIndex("MunicipalityId")
                        .HasDatabaseName("ix_report_eispp_municipality_municipality_id");

                    b.HasIndex("ReportDataId")
                        .HasDatabaseName("ix_report_eispp_municipality_report_data_id");

                    b.ToTable("report_eispp_municipality", (string)null);
                });
            ...
            modelBuilder.Entity("SISMA.Infrastructure.Data.Models.Common.CommonCourtDistance", b =>
                {
                    b.HasOne("SISMA.Infrastructure.Data.Models.Common.CommonCourt", "Court")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_common_court_distance_common_court_court_id");
                    ...
                    b.HasOne("SISMA.Infrastructure.Data.Models.Ekatte.EkEkatte", "Ekatte")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_common_court_distance_ek_ekatte_ek_ekatte_id");
            ...
            modelBuilder.Entity("SISMA.Infrastructure.Data.Models.Report.ReportEisppMunicipality", b =>
                {
                    b.HasOne("SISMA.Infrastructure.Data.Models.Nomenclatures.NomCatalogCode", "CatalogCode")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_report_eispp_municipality_nom_catalog_code_catalog_code_id");
                    ...
                    b.HasOne("SISMA.Infrastructure.Data.Models.Ekatte.EkMunincipality", "Munincipality")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_report_eispp_municipality_ek_munincipality_municipality_id");

                    b.HasOne("SISMA.Infrastructure.Data.Models.Report.ReportData", "ReportData")
                        .WithMany("DetailsEisppMunicipality")
                        .HasForeignKey("ReportDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_report_eispp_municipality_report_data_report_data_id");
            ...
            modelBuilder.Entity("SISMA.Infrastructure.Data.Models.Report.ReportData", b =>
                {
                    ...
                    b.Navigation("DetailsEisppMunicipality");
